            ...
            <div className={styles.wrapper_content_box_services}>
              <div className={styles.wrapper_content_box_services_block}>
                ...
                >
                  ...
                  <p>
                    Мы готовы помочь вам в составлении плана вашего путешествия.
                    Множество экскурсий, которые принесут вам незабываемые
                    впечатления.
                  </p>
                </div>
                <div
                ...
                >
                  ...
                  <h4>Питание</h4>
                  <p>
                    6-ти разовое питание никогда не оставит вас голодным. Любая
                    еда на ваш вкус.
                  </p>
                </div>
                ...
                >
                  ...
                  <p>
                    Мы всегда сможем присмотреть за вашим ребенком. Детская
                    игровая комната не даст вашему ребенку заскучать, а
                    проффесиональные няни всегда смогут позабоиться о вашем
                    ребенке.
                  </p>
                </div>
                <div
                ...
                >
                  ...
                  <p>
                    В нашем отеле вы найдете лучшие водные процедуры: баня,
                    хаммам, джакузи, 8 бассеинов по всей территории отеля.
                  </p>
                </div>
                <div
                  className={styles.wrapper_content_box_services_block_contents}
                >
                  ...
                  <h4>Личный досуг</h4>
                  <p>
                    У нас предусмотрены комнаты для личного досуга, бизнесс
                    встреч, а так же комната где можно отдохнуть от шума и
                    движения.
                  </p>
                </div>
                <div
                ...
                >
                  ...
                  <h4>Бар & Алкоголь </h4>
                  <p>
                    Бар расположен возле бассеина. В баре вы сможете найти
                    алкоголь на свой вкус. Бармены сделают вам любой коктель
